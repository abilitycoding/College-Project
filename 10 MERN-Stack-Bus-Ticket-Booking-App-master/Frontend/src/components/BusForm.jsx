...
function BusForm({ showBusForm, setShowBusForm, type = "add", selectedBus ,getData , setSelectedBus}) {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (type === "add") {
        ...
        response = await axiosInstance.post("/api/buses/update-bus", {...values, _id :selectedBus._id });
