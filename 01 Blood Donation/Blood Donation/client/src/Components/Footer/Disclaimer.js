...
const Disclaimer = () => {
  return (
    <Container>
      <h1 className="text-center my-5">Disclaimer</h1>
      <p>
      ...
      <h2>Disclaimers for Life Blood:</h2>

      <p>
        All the information on this website -{" "}
        <a href="https://www.lifeblood.com/">Life Blood</a> - is published in
        good faith and for general information purpose only. Life Blood does not
        ...
        this website (Life Blood), is strictly at your own risk. Life Blood will
