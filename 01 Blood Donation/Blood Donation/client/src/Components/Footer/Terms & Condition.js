...
const TermsCondition = () => {
  return (
    <Container>
      <h1 className="text-center my-5">Terms & Condition</h1>
      <h3>Welcome to Life Blood!</h3>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Life Blood's Website, located at https://www.lifeblood.com/
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Life Blood if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Life Blood, you agreed to use
        cookies in agreement with Life Blood's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Life Blood and/or its licensors own the
        intellectual property rights for all material on Life Blood. All
        intellectual property rights are reserved. You may access this from Life
        Blood for your own personal use subject to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Life Blood</li>
        <li>Sell, rent or sub-license material from Life Blood</li>
        <li>Reproduce, duplicate or copy material from Life Blood</li>
        <li>Redistribute content from Life Blood</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Life
        Blood does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Life Blood, its agents, and/or affiliates. Comments reflect the views
        and opinions of the person who posts their views and opinions. To the
        extent permitted by applicable laws, Life Blood shall not be liable for
      ...
      <p>
        Life Blood reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Life Blood a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Life Blood, and (d) the link is
      ...
      <p>
        ...
        e-mail to Life Blood. Please include your name, your organization name,
      ...
      <p>
        No use of Life Blood's logo or other artwork will be allowed for linking
      ...
      <p>
        If you want to contact us then you can email us at lifeblood@gmail.com
        also, you can contact us by our contact us form.Go to homepage --&gt;{" "}
        <a href="https://Life Blood.in">Life Blood</a>
      </p>
      <p>
        <center>"Thanks for visiting our Terms & Conditions Page"</center>
      </p>
    </Container>
  );
};
