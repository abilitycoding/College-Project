  ...
  return (
    <div className="bg-[#f9fafe] min-h-screen border border-t-slate-200 relative">
      ...
      <div className="lg:max-w-2xl max-w-md mx-auto mt-8 lg:mt-32 flex flex-col">
        ...
        <input
          className="py-1.5 border border-gray-700 rounded px-1"
          type={"text"}
          value={name}
        ...
        <input
          className={`py-1.5 border ${
            err == "Email not valid" ? "border-red-600" : "border-gray-700"
          } rounded px-1`}
          type={"email"}
          value={email}
        ...
        <input
          className={`py-1.5 border ${
            err == "Password is weak" ? "border-red-600" : "border-gray-700"
          } rounded px-1`}
          type={"password"}
          value={password}
