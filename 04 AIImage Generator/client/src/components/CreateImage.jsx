    ...
    <div className="bg-[#f9fafe] border border-t-slate-200 relative">
      {!loggedIn && (
        <div className="bg-green-500 rounded w-48 absolute right-0">
          <p className="px-1.5 py-2 text-center text-white font-semibold">
      ...
      <div className="pt-8 w-11/12 mx-auto max-w-7xl">
        ...
        <br />
        <input
          className="border text-slate-400 border-slate-400 w-full rounded text-sm p-2 mt-2 focus:outline-none mb-4"
          value={userName}
        ...
        <label>Prompt</label>
        <button
          className="ml-2 border rounded text-sm bg-[#EcECF1] font-semibold px-2"
        ...
        <input
          name="text-area"
          className="border border-slate-400 w-full rounded text-sm p-2 mt-2 focus:outline-none "
        ...
        />
        <img
          src={generatingImage ? loader : photo}
          className="w-80 mt-7 max-w-xs border-2 rounded"
        />
        {generatingImage ? (
          <button
            className="border rounded bg-green-800 py-2 px-4 text-white font-semibold mt-4"
            disabled
          >
            Generating...
          </button>
          ...
          <button
            className="border rounded bg-green-600 py-2 px-4 text-white font-semibold mt-4"
        ...
        {sharingImage ? (
          <button
            className="border rounded bg-blue-800 py-2 px-4 text-white font-semibold mt-2 mb-6"
            disabled
          >
            Sharing...
          </button>
          ...
          <button
            type="submit"
            className="border rounded bg-blue-500 py-2 px-4 text-white font-semibold mt-2 mb-6"
            onClick={shareImage}
          >
