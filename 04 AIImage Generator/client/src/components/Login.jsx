  ...
  return (
    <div className="bg-[#f9fafe] min-h-screen border border-t-slate-200 relative">
      ...
      <div className="lg:max-w-2xl max-w-md mx-auto mt-8 lg:mt-32 flex flex-col">
        ...
        <input
          className={`py-1.5 border ${
            err == "Email not found" ? "border-red-600" : "border-gray-700"
          } rounded px-1`}
          type={"email"}
          value={email}
        ...
        <input
          className={`py-1.5 border ${
            err == "Password Incorrect" ? "border-red-600" : "border-gray-700"
          } rounded px-1`}
          type={"password"}
          value={password}
        ...
        {!loggingIn ? (
          <button
            className="w-full border rounded bg-purple-600 border-gray-600 mt-6 text-white font-medium py-1 self-center"
            onClick={() => {
              setLoggingIn(true);
              logIn();
            }}
          ...
          <button
            className="w-full border rounded bg-purple-800 border-gray-600 mt-6 text-white font-medium py-1 self-center"
            disabled
          >
            Logging In
          </button>
      ...
      <div className="lg:max-w-2xl max-w-md mx-auto mt-8">
        ...
        <Link to={"/signup"}>
          <button className="text-purple-600 text-lg border-b-2 border-purple-600 font-semibold">
            Signup
          </button>
        </Link>
      </div>
