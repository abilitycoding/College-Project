        ...
        <Form className="w-100">
          ...
          <Form.Group className="mb-3" controlId="formEmail">
            <Form.Control
              ...
              value={data.email}
              onChange={handleChange}
              isInvalid={!data.email && formSubmitted}
              required
            />
            <Form.Control.Feedback type="invalid">
              Please enter Email.
          ...
          <Form.Text className="my-3 fs-5 fw-bold">Are you ?</Form.Text>
          <Form.Group controlId="checkboxGroup" className="d-flex gap-3 pb-3">
            <Form.Check
              type="checkbox"
              label="Student"
              name="student"
            ...
            <Form.Check
              ...
              name="working"
              id="CheckboxWorking"
              checked={data.userType === "working"}
              onChange={() => handleCheckboxChange("working")}
              required
            />
          </Form.Group>
...
const BootCampAdmin = () => {
  ...
  return (
    <div
      ...
      data-bs-theme="dark"
    >
      {reduxUserData == "inovsandy@gmail.com" ? (
                  ...
                  <tbody className="Table_body">
                    {currentUsers.map((user, index) => (
                      <tr key={user._id}>
                        ...
                        <td>{user.userType}</td>
                        <td>
                          <BsUpload onClick={() => setModalShow(userData)} />
                          <MyVerticallyCenteredModal
                            show={modalShow !== false} // Check if modalShow is not false (i.e., userData is passed)
                            onHide={() => setModalShow(false)}
                            userData={user} // Pass the userData as a prop to the modal
