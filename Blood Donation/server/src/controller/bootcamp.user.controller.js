...
router.post("/user-register", (req, res) => {
  const { name, email, phoneNumber, city, userType, isConnected } = req.body;
  console.log(req.body);
  BootCampUser.findOne({ email: email })
    .then((user) => {
      if (user) {
...
router.put("/user-update/:id", async (req, res) => {
  ...
  try {
    ...
    existingUser.isConnected = isConnected || existingUser.isConnected;
