...
const Heading = styled.h1`
  ...
  margin: 2rem;
  text-align: center;
  border-bottom: 1px solid #7a5bc7;
`;
...
const FacultyAttendance = () => {
  ...
  const setAttendance = (e) => {
    ...
    dispatch(
      markAttendance(checkedValue, subjectCode, department, year, section)
    );
    setCheckedValue([]);
        ...
        <>
          ...
          <Container>
            <Form>
              ...
              <FormItemContainer>
                {!isLoading && (
                  <Button type="submit" onClick={getStudents}>
                    Search
                  </Button>
                )}
              </FormItemContainer>
            ...
            <DataGrid
              ...
              onSelectionModelChange={(ids) => {
                ...
                const selectedStudents = rows.filter((row) =>
