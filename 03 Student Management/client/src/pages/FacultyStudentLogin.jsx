...
const Container = styled.div`
  width: 100vw;
  height: 100vh;
  background: linear-gradient(75deg, #7a5bc7 50%, #ffffff 50%);
  display: flex;
  align-items: center;
...
const FacultyStudentLogin = () => {
  ...
  const { isAuthenticated: facultyAuthenticated } = useSelector(
    (state) => state.faculty
  );
        ...
        <Right>
          {isStudentLogin ? (
            <LoginBox>
              ...
              <LoginInfo onClick={handleToggle}>Login as Faculty?</LoginInfo>
              <LoginInfo>
            ...
            <LoginBox>
              ...
              <LoginInfo onClick={handleToggle}>Login as Student?</LoginInfo>
              <LoginInfo>
